...
define ('BASE_PATH_PARENT', dirname( dirname(__FILE__) ) . DIRECTORY_SEPARATOR);
define ('SYS_PATH', dirname( dirname(__FILE__) ) . DIRECTORY_SEPARATOR . 'system' . DIRECTORY_SEPARATOR);
