	...
	<div class="card-body">
		<?php 
			...
			echo btn_label([
				...
				'label' => '<i class="fas fa-plus"></i> Tambah User'
			]);
			
			echo btn_label([
				'url' => module_url(),
				'attr' => ['class' => 'btn btn-light btn-xs'],
				'label' => '<i class="fas fa-arrow-circle-left"></i> Daftar User'
			]);
		?>
		<hr/>
		<?php
		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content">
						...
						if (!empty($avatar) ) {
							echo '<div class="img-choose" style="margin:inherit;margin-bottom:10px">
									<div class="img-choose-container">
										<img src="'. $config['base_url_parent'] . 'public/images/user/' . $avatar . '?r=' . time() . '"/>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8 form-inline">
						<?php echo options(['name' => 'verified'], [1 => 'Ya', 0=>'Tidak'], set_value('verified', @$verified)); ?>
					</div>
				</div>
