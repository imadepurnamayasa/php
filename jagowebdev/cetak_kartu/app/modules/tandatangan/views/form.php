			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-5">
						...
						echo '<div class="foto-container" style="margin:inherit;margin-bottom:10px"><img src="'.BASE_URL. $config['kartu_path'] . $value_tandatangan . '"/></div>';
				...
				<div class="form-group row mb-3">
					...
					<div class="col-sm-5">
						...
						echo '<div class="foto-container" style="margin:inherit;margin-bottom:10px"><img src="'.BASE_URL. $config['kartu_path'] . $value_cap_tandatangan . '"/></div>';
