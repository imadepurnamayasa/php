...
<div class="wrapper">
	...
	<h1>Link Aktivasi Akun</h1>
	<p>Hi, {{NAME}}, Anda baru saja mendaftar di Aplikasi Cetak Kartu Berbasis Web. Untuk menyelesaikan proses pendaftaran, konfirmasi alamat email Anda dengan mengklik tombol berikut ini:</p>
	<p>
		<a class="button" href="{{url}}" target="_blank" >
