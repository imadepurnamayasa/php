...
-- Dumping structure for table gallerymanager.file_picker
...
-- Dumping data for table gallerymanager.file_picker: ~67 rows (approximately)
...
-- Dumping structure for table gallerymanager.gallery
...
-- Dumping data for table gallerymanager.gallery: ~61 rows (approximately)
...
-- Dumping structure for table gallerymanager.gallery_kategori
...
-- Dumping data for table gallerymanager.gallery_kategori: ~5 rows (approximately)
...
-- Dumping structure for table gallerymanager.menu
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT COMMENT='Tabel menu aplikasi';

-- Dumping data for table gallerymanager.menu: ~16 rows (approximately)
...
INSERT INTO `menu` (`id_menu`, `nama_menu`, `class`, `url`, `id_module`, `id_parent`, `aktif`, `new`, `urut`) VALUES
	...
	(14, 'Demo Gallery', 'fas fa-desktop', '{{BASE_URL_PARENT}}', 0, NULL, 1, 0, 5),
	(15, 'Demo Admin', 'fas fa-dice-d6', 'https://jagowebdev.com/demo/menumanager/adminpanel', 0, NULL, 0, 0, 7),
	(16, 'Filepicker Manager', 'far fa-copy', 'filepicker', 14, NULL, 1, 0, 3),
	(17, 'Gallery', 'far fa-images', 'gallery', 13, NULL, 1, 0, 4),
	(18, 'Demo Menu', 'fas fa-external-link-alt', '{{BASE_URL_PARENT}}menu/', 0, NULL, 1, 0, 6);
/*!40000 ALTER TABLE `menu` ENABLE KEYS */;

-- Dumping structure for table gallerymanager.menu_frontend
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT COMMENT='Tabel menu aplikasi';

-- Dumping data for table gallerymanager.menu_frontend: ~40 rows (approximately)
...
INSERT INTO `menu_frontend` (`id_menu`, `nama_menu`, `nama_group`, `class`, `url`, `id_parent`, `aktif`, `urut`) VALUES
	...
	(39, 'Demo Gallery', 'Header Admin', 'fas fa-external-link-alt', '{{BASE_URL}}', NULL, 'Y', NULL),
	...
	(48, 'Menu Frontend', 'Header', 'fas fa-external-link-alt', '{{BASE_URL}}menu/', 47, 'Y', 1),
	(49, 'Menu Admin', 'Header', 'fas fa-external-link-alt', '{{BASE_URL}}adminpanel/', 47, 'Y', 2),
	(50, 'Kategori Gallery', 'Header', 'fas fa-folder', '{{BASE_URL}}', 2, 'Y', 6);
/*!40000 ALTER TABLE `menu_frontend` ENABLE KEYS */;

-- Dumping structure for table gallerymanager.menu_frontend_group
...
-- Dumping data for table gallerymanager.menu_frontend_group: ~5 rows (approximately)
...
-- Dumping structure for table gallerymanager.menu_role
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT COMMENT='Tabel hak akses dari menu aplikasi';

-- Dumping data for table gallerymanager.menu_role: ~19 rows (approximately)
...
-- Dumping structure for table gallerymanager.module
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Tabel modul aplikasi';

-- Dumping data for table gallerymanager.module: ~14 rows (approximately)
...
-- Dumping structure for table gallerymanager.module_role
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Tabel hak akses module aplikasi, module aplikasi boleh diakses oleh user yang mempunyai role apa saja';

-- Dumping data for table gallerymanager.module_role: ~16 rows (approximately)
...
-- Dumping structure for table gallerymanager.module_status
...
-- Dumping data for table gallerymanager.module_status: ~3 rows (approximately)
...
-- Dumping structure for table gallerymanager.role
...
-- Dumping data for table gallerymanager.role: ~3 rows (approximately)
...
-- Dumping structure for table gallerymanager.role_detail
...
-- Dumping data for table gallerymanager.role_detail: ~3 rows (approximately)
...
-- Dumping structure for table gallerymanager.setting_app_tampilan
...
-- Dumping data for table gallerymanager.setting_app_tampilan: 5 rows
...
-- Dumping structure for table gallerymanager.setting_app_user
...
-- Dumping data for table gallerymanager.setting_app_user: 1 rows
...
-- Dumping structure for table gallerymanager.setting_web
...
-- Dumping data for table gallerymanager.setting_web: ~9 rows (approximately)
...
-- Dumping structure for table gallerymanager.user
...
-- Dumping data for table gallerymanager.user: ~3 rows (approximately)
...
-- Dumping structure for table gallerymanager.user_role
...
-- Dumping data for table gallerymanager.user_role: ~3 rows (approximately)
...
-- Dumping structure for table gallerymanager.user_token
...
-- Dumping data for table gallerymanager.user_token: ~0 rows (approximately)
