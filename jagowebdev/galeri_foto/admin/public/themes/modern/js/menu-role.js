							...
							success: function (data) {
								...
								if (data.status == 'ok') 
								{
									...
									$checkbox_wrapper.find('input:checked').each(function(i, elm) {
										...
										new_badge += '<span class="badge badge-secondary badge-role px-3 py-2 me-1 mb-1 pe-4">'+label+'<a data-action="remove-role" data-id-menu="'+id_menu+'" data-role-id="'+id_role+'" href="javascript:void(0)" class="text-danger"><i class="fas fa-times"></i></a></span>';
									});
									...
									if (data_parent.length > 0) {
										...
										$.each(data_parent, function(i, v) {
											...
											new_badge = '<span class="badge badge-secondary badge-role px-3 py-2 me-1 mb-1 pe-4">'+label+'<a data-action="remove-role" data-id-menu="'+v['id_menu']+'" data-role-id="'+v['id_role']+'" href="javascript:void(0)" class="text-danger"><i class="fas fa-times"></i></a></span>';
