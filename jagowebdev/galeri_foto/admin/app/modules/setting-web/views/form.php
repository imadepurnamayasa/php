<div class="card">
	<div class="card-header">
		<h5 class="card-title"><?=$module_title?></h5>
	</div>
		...
		<form method="post" action="" id="form-setting" enctype="multipart/form-data">
			<div class="tab-content">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						...
						<input type="file" class="file" name="logo_login">
							<?php if (!empty($form_errors['logo_login'])) echo '<div class="alert alert-danger">' . $form_errors['logo_login'] . '</div>'?>
							<div class="form-text text-muted"><strong>Gunakan file PNG transparan</strong>. Maksimal 300Kb, Minimal 50px x 50px, Tipe file: .JPG, .JPEG, .PNG</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<textarea class="form-control" name="title"><?=set_value('title', @$title)?></textarea>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Deskripsi Web</label>
					<div class="col-sm-5">
						<textarea class="form-control" name="description"><?=set_value('description', @$description)?></textarea>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-5">
						...
						<input type="file" class="file" name="favicon">
							<?php if (!empty($form_errors['favicon'])) echo '<div class="alert alert-danger">' . $form_errors['favicon'] . '</div>'?>
							<div class="form-text text-muted"><strong>Gunakan file PNG transparan, width dan height sama, misal: 64px x 64px</strong></div>
						<div class="upload-img-thumb"><div class="img-prop"></div></div>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-5">
						...
						<input type="file" class="file" name="logo_app">
							<?php if (!empty($form_errors['logo_app'])) echo '<div class="alert alert-danger">' . $form_errors['logo_app'] . '</div>'?>
							<div class="form-text text-muted"><strong>Gunakan file PNG transparan</strong>. Maksimal 300Kb, Minimal 50px x 50px, Tipe file: .JPG, .JPEG, .PNG</div>
						<div class="upload-img-thumb"><div class="img-prop"></div></div>
					</div>
				</div>
