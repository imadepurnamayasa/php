...
<style>
.login-header {
    background-color: <?=$setting_web['background_logo'];?>
}
</style>
<script type="text/javascript" src="<?=$config['base_url'] . 'public/vendors/jquery/jquery-3.3.1.min.js?r='.time()?>"></script>
...
<body>
	...
	<div class="login-container">
		<div class="login-header">
			<div class="logo">
				<img src="<?php echo $config['base_url'] . 'public/images/' . $setting_web['logo_login']?>?r=<?=time()?>">
			</div>
