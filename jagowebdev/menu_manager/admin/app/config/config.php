...
unset($config, $csrf_token, $check_role_action);

$config = [
	'base_url_parent' => $parent_config['base_url']
	, 'base_url' => $parent_config['base_url'] . 'admin/'
	, 'images_url' => $parent_config['base_url'] . 'admin/public/images/'
	, 'backend_path' => 'admin'
	, 'theme' => 'modern'
	, 'default_module' => 'user'
	...
	/* Filepicker */
	, 'filepicker_upload_path' => '../public/files/uploads/'
	, 'filepicker_upload_url' => $parent_config['base_url'] . 'public/files/uploads/'
	, 'filepicker_server_url' => $parent_config['base_url'] . 'admin/filepicker/'
	, 'filepicker_icon_url' => $parent_config['base_url'] . 'public/images/filepicker_images/'
];
