		...
		<form method="post" action="" id="form-setting">
			<div class="tab-content" id="myTabContent">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5 form-inline">
						<?=options(['name' => 'font_family', 'id' => 'font'], ['open-sans' => 'Open Sans (Default)', 'poppins' => 'Poppins', 'nunito' => 'Nunito', 'arial' => 'Arial', 'verdana' => 'Verdana'], set_value('font_family', @$font_family))?>
					</div>
				</div>
				<div class="form-group row">
