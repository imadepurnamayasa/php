			...
			if ($module_role[$_SESSION['user']['id_role']]['update_data'] == 'all')
			{
				...
				if ($form_errors) {
					...
					if ($logo_login && $logo_app && $favicon) 
					{
						...
						$data_db[] = ['param' => 'title', 'value' => $_POST['title']];
						$data_db[] = ['param' => 'description', 'value' => $_POST['description']];
...
// echo '<pre>'; print_r($data); die;
		$data['module_title'] = 'Edit ' . $current_module['judul_module'];
...
function validate_form() 
{
	...
	$validation->setRules('title', 'Judul Website', 'trim|required');
	$validation->setRules('description', 'Deskripsi Web', 'trim|required');
