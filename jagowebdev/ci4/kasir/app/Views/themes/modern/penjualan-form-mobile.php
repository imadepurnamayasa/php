						...
						<div class="nama-barang-container d-flex justify-content-between">
							...
							<div class="d-flex flex-nowrap">
								<div class="input-group input-group-counter d-flex align-items-start" style="width:120px">
									...
									<input type="text" size="4" class="form-control text-end qty" style="width:40px" name="qty[]" value="<?=format_number($val['qty'], true)?>"/>
								...
								if ($setting_kasir['qty_pengali'] == 'Y') {
									...
									<div class="input-group d-flex flex-nowrap align-items-start" style="width: 80px;">
										<input type="text" class="form-control text-end qty-pengali" style="width:55px" name="qty_pengali[]" value="<?=format_number(@$val['qty_pengali'], true) ?> "/>
