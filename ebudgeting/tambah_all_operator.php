<?php 
	if (isset($_POST[simpan])){
		...
		$passs = trim($_POST[b]);
		$passd = md5($passs);
			mysql_query("INSERT INTO rb_user (username,password,nama_lengkap,no_telpon,alamat_lengkap,keterangan) 
							VALUES ('$userr','$passd','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]')");
		
		echo "<script>window.alert('Sukses Tambahkan Data Operator.');
...
<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Tambahkan Data Operator</a>
		</div>
	  </div><!-- /navbar-inner -->
	</div><!-- /navbar -->
